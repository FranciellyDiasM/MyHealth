...
object DB {
    ...
    object USER {
        ...
        val CREATE_TABLE = """
            CREATE TABLE $TABLE_NAME (
                ...
                FOREIGN KEY ($COLUMN_OBJECTIVE_ID) REFERENCES ${OBJECTIVE.TABLE_NAME}(${OBJECTIVE.COLUMN_ID}) ON DELETE CASCADE
            );
        """.trimIndent()
    ...
    object INGREDIENT {
        const val TABLE_NAME = "ingrediente"
    ...
    object INGREDIENT_MEAL {
        ...
        val CREATE_TABLE = """
            CREATE TABLE $TABLE_NAME (
                ...
                FOREIGN KEY ($COLUMN_INGREDIENT_ID) REFERENCES ${INGREDIENT.TABLE_NAME}(${INGREDIENT.COLUMN_ID}) ON DELETE CASCADE,
                FOREIGN KEY ($COLUMN_MEAL_ID) REFERENCES ${MEAL.TABLE_NAME}(${MEAL.COLUMN_ID}) ON DELETE CASCADE,
                FOREIGN KEY ($COLUMN_UNIT_OF_MEASURE_ID) REFERENCES ${UNIT_OF_MEASUREMENT.TABLE_NAME}(${UNIT_OF_MEASUREMENT.COLUMN_ID}) ON DELETE CASCADE
            );
        """.trimIndent()
